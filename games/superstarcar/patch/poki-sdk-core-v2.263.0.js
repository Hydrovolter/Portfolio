(() => {
	...
	i.n = e => {
		...
		const D = function(e) {
			r.debug ? console.log(e) : fetch("patch/json/null.json", {
				method: "get",
				mode: "no-cors",
							...
							if (s) {
								if (c) {
									var w = function(e) {
										...
										return n ? {
											bid: n,
											vast: "patch/json/null.json" + I("amzniid", t) + "&rnd=" + Math.round(1e10 * Math.random()) + "&pp=" + i
										} : null
									}(c);
								...
								if (1 !== d && (!k || !k.videoCacheKey || k.cpm < B(o))) {
									...
									"ninja.io" === (null === (g = null === window || void 0 === window ? void 0 : window.location) || void 0 === g ? void 0 : g.hostname) && (S = function(e) {
										...
										cpm: S,
										vast: "patch/json/null.json" + ("" === $e.gameId ? "" : "?game_id=" + $e.gameId),
										bidder: "poki",
										videoCacheKey: "poki"
									}
								}
								...
								switch (k.bidder) {
									case "onetag":
										v = "patch/json/null.json" + k.videoCacheKey;
										break;
									case "rubicon":
										v = "patch/json/null.json" + k.videoCacheKey;
										break;
		...
		const je = function() {
			...
			return fetch("patch/json/null.json" + t + "&referrer=" + i, {
				method: "GET",
				headers: {
							...
							switch (p.label) {
								...
								case 2:
									if (i = r.apply(n, [(c.d = [(l.v = a.apply(o, [(u.json = s, u.body = JSON.stringify({
										...
										}), u.name = e.name, u.message = e.message, u)]), l)], c)]), d = "patch/json/null.json", console.log) console.log(d, i);
									else try {
		...
		function Re() {
			return ze(this, void 0, Promise, (function() {
				...
				return Me(this, (function(r) {
					switch (r.label) {
						case 0:
							return r.trys.push([0, 3, , 4]), [4, fetch("patch/json/null.json", {
								method: "GET",
								headers: {
									"Content-Type": "text/plain"
								}
