	...
	if (!mobile) {
        if (paused && (state == "game" || state == "intermission")) {
            ...
            */
            ...
            canvas.font = "Bold " + IG_BTN_TEXT_SIZE + "px Arial";
            canvas.textAlign = "center";
            canvas.fillText("BY: HYDROVOLTER", CANVAS_WIDTH / 2, IG_BUTTONS_TOP + IG_BTN_SPACE * 7);
        }
	} else {
        if (paused && (state == "game" || state == "intermission")) {
            ...
            */
            ...
            canvas.font = "Bold " + cwh(IG_BTN_TEXT_SIZE) + "px Arial";
            canvas.textAlign = "center";
            canvas.fillText("BY: HYDROVOLTER", cwh(CANVAS_WIDTH / 2) + os.x, cwh(IG_BUTTONS_TOP + IG_BTN_SPACE * 7) + os.y);
        }
    }
}
