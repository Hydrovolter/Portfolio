function drawBars() {
    if (mobile) {
        ...
        // main menu / level select text
            ...
            canvas.font = cwh(30) + "px Arial";
            canvas.textAlign = "left";
            canvas.fillText("CREATOR: HYDROVOLTER", cwh(BAR_TEXT_FIX) + os.x, cwh(BAR_HEIGHT / 2 + BAR_TEXT_FIX) + os.y);

            canvas.fillStyle = "white";
            canvas.font = cwh(30) + "px Arial";
            canvas.textAlign = "right";
            canvas.fillText("MUSIC: HYDROVOLTER", cwh(CANVAS_WIDTH - BAR_TEXT_FIX) + os.x, cwh(BAR_HEIGHT / 2 + BAR_TEXT_FIX) + os.y);
        ...
        // main menu / level select text
            ...
            canvas.font = "30px Arial";
            canvas.textAlign = "left";
            canvas.fillText("CREATOR: HYDROVOLTER", BAR_TEXT_FIX, BAR_HEIGHT / 2 + BAR_TEXT_FIX);
            ...
            canvas.font = "30px Arial";
            canvas.textAlign = "right";
            canvas.fillText("MUSIC: HYDROVOLTER", CANVAS_WIDTH - BAR_TEXT_FIX, BAR_HEIGHT / 2 + BAR_TEXT_FIX);
